...
var Share={go:function(e,t){var o=Share,n=$.extend({type:"vk",url:location.href,count_url:location.href,title:"Искушение от MAXIM и paco rabanne",image:"../img/product.png",text:"Искушение от MAXIM и paco rabanne"},$(e).data(),t);return null===o.popup(link=o[n.type](n))&&($(e).is("a")?($(e).prop("href",link),!0):(location.href=link,!1))},vk:function(e){var t=$.extend({url:location.href,title:"Искушение от MAXIM и paco rabanne",image:"/img/product.png",text:"Искушение от MAXIM и paco rabanne"},e);return"http://vkontakte.ru/share.php?url="+encodeURIComponent(t.url)+"&title="+encodeURIComponent(t.title)+"&description="+encodeURIComponent(t.text)+"&image="+encodeURIComponent(t.image)+"&noparse=true"},ok:function(e){var t=$.extend({url:location.href,text:"Искушение от MAXIM и paco rabanne"},e);return"http://www.odnoklassniki.ru/dk?st.cmd=addShare&st.s=1&st.comments="+encodeURIComponent(t.text)+"&st._surl="+encodeURIComponent(t.url)},fb:function(e){var t=$.extend({url:location.href,title:"Искушение от MAXIM и paco rabanne",image:"/img/product.png",text:"Искушение от MAXIM и paco rabanne"},e);return"http://www.facebook.com/sharer.php?s=100&p[title]="+encodeURIComponent(t.title)+"&p[summary]="+encodeURIComponent(t.text)+"&p[url]="+encodeURIComponent(t.url)+"&p[images][0]="+encodeURIComponent(t.image)},lj:function(e){var t=$.extend({url:location.href,title:document.title,text:""},e);return"http://livejournal.com/update.bml?subject="+encodeURIComponent(t.title)+"&event="+encodeURIComponent(t.text+'<br/><a href="'+t.url+'">'+t.title+"</a>")+"&transform=1"},tw:function(e){var t=$.extend({url:location.href,title:"Искушение от MAXIM и paco rabanne"},e);return"http://twitter.com/share?text="+encodeURIComponent(t.title)+"&url="+encodeURIComponent(t.url)},mr:function(e){var t=$.extend({url:location.href,title:document.title,image:"",text:""},e);return"http://connect.mail.ru/share?url="+encodeURIComponent(t.url)+"&title="+encodeURIComponent(t.title)+"&description="+encodeURIComponent(t.text)+"&imageurl="+encodeURIComponent(t.image)},popup:function(e){return window.open(e,"","toolbar=0,status=0,scrollbars=1,width=626,height=436")}};$(document).on("click",".social__link",function(e){e.preventDefault(),Share.go(this)}),$(document).ready(function(){$(".slider-row").slick({infinite:!0,arrows:!1,dots:!0,customPaging:function(e,t){$(e.$slides[t]).data();return"<a>0"+(t+=1)+"</a>"},nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(window).width()<=960&&$(".slider-row").slick("unslick"),$(window).resize(function(){$(this).width()<=960?$(".slider-row").slick("unslick"):$(".slider-row").slick({infinite:!0,arrows:!1,dots:!0,customPaging:function(e,t){$(e.$slides[t]).data();return"<a>0"+(t+=1)+"</a>"},nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:1e3})}),$(".blogger-row").slick({infinite:!0,arrows:!0,dots:!1,slidesToShow:3,slidesToScroll:1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',autoplay:!0,autoplaySpeed:1e4,speed:1e3,responsive:[{breakpoint:900,settings:{slidesToShow:2}},{breakpoint:700,settings:{slidesToShow:1,speed:300,fade:!0}}]});var e=$(".header"),t=$(".header-nav");$(t).on("click","a",function(o){o.preventDefault();var n=$(this).attr("href"),r=$(n).offset().top;$("html, body").animate({scrollTop:r-$(e).height()},900),$(window).width()<=1e3&&($(e).removeClass("open"),$(t).slideToggle())}),$(".menu-bar").on("click",function(){$(".header").toggleClass("open"),$(t).slideToggle()}),$(window).width()>768&&(!function(e){e.fn.animated=function(t){e(this).each(function(){var o=e(this);o.css("opacity","0").addClass("animated").waypoint(function(e){"down"===e&&o.addClass(t).css("opacity","1")},{offset:"95%"})})}}(jQuery),$("h6, h5, h4, h3, h2, h1, div p, div img").animated("fadeIn","fadeOutDown"))});