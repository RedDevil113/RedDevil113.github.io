...
$(document).ready(function(){$(".hotels-slider").slick({centerMode:!0,infinite:!0,slidesToShow:1,centerPadding:0,speed:500,variableWidth:!0}),$(".offers-slider").slick({slidesToShow:1,centerPadding:0,speed:500,variableWidth:!0}),$(".menu-bar").on("click",function(){$(".menu-mob").toggleClass("menu-mob__active")}),$(".menu-mob__close").on("click",function(){$(".menu-mob").toggleClass("menu-mob__active")}),$(".about-video__play").on("click",function(e){var a=$(".about-video__link").text();$(".about-video").addClass("about-video__active"),$(".about-video iframe").attr("src",a)}),$(".drop-head").on("click",function(){$(this).next().toggleClass("drop-list__active")}),$(".tab-head li a").on("click",function(e){e.preventDefault();var a=$(this).attr("href");$(".tab-head li a").removeClass("active"),$(".tab-block").removeClass("tab-active"),$(this).addClass("active"),$(a).addClass("tab-active")});var e=$(".modal"),a=$(".modal-overlay");$(".button-modal").on("click",function(e){e.preventDefault();var o=$(this).attr("href");$(o).addClass("open"),$(this).hasClass("btn-mob")||$(a).addClass("open-overlay")}),$(".cancel,.cancel-modal").on("click",function(){$(e).removeClass("open"),$(a).removeClass("open-overlay")}),$(a).on("click",function(){$(e).removeClass("open"),$(a).removeClass("open-overlay")})});