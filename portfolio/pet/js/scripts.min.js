...
$(document).ready(function(){$(".grid").masonry({columnWidth:".grid-sizer",itemSelector:".grid-item",percentPosition:!0,horizontalOrder:!0}),$(".main-info__drop-head").on("click",function(){$(this).parents(".main-info__drop-up").hasClass("main-info__drop-up__active")?($(".main-info__drop-up").removeClass("main-info__drop-up__active"),$(this).parents(".main-info__drop-up").removeClass("main-info__drop-up__active")):($(".main-info__drop-up").removeClass("main-info__drop-up__active"),$(this).parents(".main-info__drop-up").addClass("main-info__drop-up__active"),$(".bg-black").toggleClass("bg-black__active"))}),$(".main-info__drop-new").on("click",function(a){$(this).parents(".main-info__drop-down").addClass("main-info__drop-down__second")}),$(".hotels-slider").slick({centerMode:!0,infinite:!0,slidesToShow:1,centerPadding:0,speed:500,variableWidth:!0}),$(".offers-slider").slick({slidesToShow:1,centerPadding:0,speed:500,variableWidth:!0}),$(".menu-bar").on("click",function(){$(".menu-mob").toggleClass("menu-mob__active")}),$(".menu-mob__close").on("click",function(){$(".menu-mob").toggleClass("menu-mob__active")}),$(".about-video__play").on("click",function(a){var e=$(".about-video__link").text();$(".about-video").addClass("about-video__active"),$(".about-video iframe").attr("src",e)}),$(".drop-head").on("click",function(){$(this).next().toggleClass("drop-list__active")}),$(".tab-head li a").on("click",function(a){a.preventDefault();var e=$(this).attr("href");$(".tab-head li a").removeClass("active"),$(".tab-block").removeClass("tab-active"),$(this).addClass("active"),$(e).addClass("tab-active")}),$(".map-list li a").on("click",function(a){a.preventDefault();var e=$(this).attr("href");$(".map-list li a").removeClass("active"),$(".map-tab__block").removeClass("map-tab__block-active"),$(this).addClass("active"),$(e).addClass("map-tab__block-active")}),$(".modal-head__list li a").on("click",function(a){a.preventDefault();var e=$(this).attr("href");$(".modal-head__list li a").removeClass("active"),$(".modal-tab").removeClass("modal-tab__active"),$(this).addClass("active"),$(e).addClass("modal-tab__active")}),$(".main-wrap__step-1").hasClass("main-wrap__step-active")?$(".main").addClass("main-2"):$(".main").removeClass("main-2"),$(".main-wrap__step").on("click",function(){$(".main-wrap__step-4").hasClass("main-wrap__step-active")||($(".main-wrap__step").removeClass("main-wrap__step-active"),$(this).next(".main-wrap__step").addClass("main-wrap__step-active"),$(".main-wrap__step-1").hasClass("main-wrap__step-active")?$(".main").addClass("main-2"):$(".main").removeClass("main-2"))}),$(".text-to-input a").on("click",function(a){a.preventDefault(),$(this).parents(".text-to-input").toggleClass("text-to-input__active")});var a=$(".modal"),e=$(".modal-overlay");$(".button-modal").on("click",function(a){a.preventDefault();var i=$(this).attr("href");$(i).addClass("open"),$(this).hasClass("btn-mob")||$(e).addClass("open-overlay")}),$(".cancel,.cancel-modal").on("click",function(){$(a).removeClass("open"),$(e).removeClass("open-overlay")}),$(e).on("click",function(){$(a).removeClass("open"),$(e).removeClass("open-overlay")}),$("#datepicker").datepicker()}),function(){window.inputNumber=function(a){function e(a){function e(){var e=a[0].value;e--,(!i||e>=i)&&(a[0].value=e)}function o(){var e=a[0].value;e++,(!t||e<=t)&&(a[0].value=e++)}n.dec.on("click",e),n.inc.on("click",o)}var i=a.attr("min")||!1,t=a.attr("max")||!1,n={};n.dec=a.prev(),n.inc=a.next(),a.each(function(){e($(this))})}}(),inputNumber($(".input-number"));