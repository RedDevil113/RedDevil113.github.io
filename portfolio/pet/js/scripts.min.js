...
$(document).ready(function(){$(".hotels-slider").slick({centerMode:!0,infinite:!0,slidesToShow:1,centerPadding:0,speed:500,variableWidth:!0}),$(".offers-slider").slick({slidesToShow:1,centerPadding:0,speed:500,variableWidth:!0}),$(".menu-bar").on("click",function(){$(".menu-mob").toggleClass("menu-mob__active")}),$(".menu-mob__close").on("click",function(){$(".menu-mob").toggleClass("menu-mob__active")}),$(".about-video__play").on("click",function(a){var e=$(".about-video__link").text();$(".about-video").addClass("about-video__active"),$(".about-video iframe").attr("src",e)}),$(".drop-head").on("click",function(){$(this).next().toggleClass("drop-list__active")}),$(".tab-head li a").on("click",function(a){a.preventDefault();var e=$(this).attr("href");$(".tab-head li a").removeClass("active"),$(".tab-block").removeClass("tab-active"),$(this).addClass("active"),$(e).addClass("tab-active")}),$(".map-list li a").on("click",function(a){a.preventDefault();var e=$(this).attr("href");$(".map-list li a").removeClass("active"),$(".map-tab__block").removeClass("map-tab__block-active"),$(this).addClass("active"),$(e).addClass("map-tab__block-active")});var a=$(".modal"),e=$(".modal-overlay");$(".button-modal").on("click",function(a){a.preventDefault();var o=$(this).attr("href");$(o).addClass("open"),$(this).hasClass("btn-mob")||$(e).addClass("open-overlay")}),$(".cancel,.cancel-modal").on("click",function(){$(a).removeClass("open"),$(e).removeClass("open-overlay")}),$(e).on("click",function(){$(a).removeClass("open"),$(e).removeClass("open-overlay")})});