...
$(document).ready(function(){if(AOS.init(),$(".instructor-slider,.testimonials-slider").slick({infinite:!0,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:500,centerMode:!0,variableWidth:!0,responsive:[{breakpoint:768,settings:{centerMode:!1}}]}),$(".personalArea-slider").slick({infinite:!1,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:3,slidesToScroll:1,speed:500,variableWidth:!0,responsive:[{breakpoint:1380,settings:{slidesToShow:2}},{breakpoint:600,settings:{slidesToShow:1}}]}),$(".timetables-slider").slick({infinite:!1,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:3,slidesToScroll:1,speed:500,variableWidth:!0,responsive:[{breakpoint:1380,settings:{slidesToShow:2}},{breakpoint:680,settings:{slidesToShow:1}}]}),$(".header-menu, .main-info").on("click","a",function(t){t.preventDefault();var e=$(this).attr("href"),s=$(e).offset().top;$("html, body").animate({scrollTop:s},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$(i).removeClass("open"),$(".modal-overlay").removeClass("open-overlay"),$(".menu").length&&$(".menu").toggleClass("menu-active")}),$(".drop-text").on("click",function(t){t.preventDefault(),$(this).parents(".drop").toggleClass("active"),$(window).width()<=960&&$(this).next().slideToggle()}),$(".header-user__top").on("click",function(){$(".header-user").toggleClass("active")}),$(document).on("click",function(t){var e=$(".header");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".header").removeClass("header-active")}),$(document).on("click",function(t){var e=$(".drop");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".drop").removeClass("active")}),$(document).on("click",function(t){var e=$(".header-user");e.is(t.target)||0!==e.has(t.target).length||$(".header-user").removeClass("active")}),$(".slick-current.slick-active .instructor-overlay").on("click",function(){var t=$(this).parents(".instructor-video");url=$(t).find(".instructor-url").text(),$(t).addClass("active"),$(t).find("iframe").attr("src",url)}),$(".tab-list li a").on("click",function(t){t.preventDefault(),$(".tab-list li a").removeClass("active"),$(".tab").removeClass("tab-active");var e=$(t.target).attr("href");$(e).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),$(".grid").masonry({itemSelector:".grid-item",percentPosition:!0}),$(".input-textarea textarea").keyup(function(){var t=$(this).val().length;$(this).attr("maxlength","1000").parents(".input-textarea").find(".input-textarea__info b").text(1e3-t)}),$("#statistics1").length){var t=new ProgressBar.Circle(statistics1,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=Math.round(e.value()*$("#statistics1-1").text());0===s?e.setText(""):e.setText(s)}});t.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',t.text.style.fontSize="48px",t.animate($("#procent-1").text(),{duration:1500})}if($("#statistics2").length){var e=new ProgressBar.Circle(statistics2,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=Math.round(e.value()*$("#statistics2-2").text());0===s?e.setText(""):e.setText(s+"<span>+</span>")}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="48px",e.animate($("#procent-2").text(),{duration:1500})}if($("#statistics3").length){var s=new ProgressBar.Circle(statistics3,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=Math.round(e.value()*$("#statistics3-3").text());0===s?e.setText(""):e.setText(s+"<span>+</span>")}});s.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',s.text.style.fontSize="48px",s.animate($("#procent-3").text(),{duration:1500})}if($("#statistics4").length){var a=new ProgressBar.Circle(statistics4,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=Math.round(e.value()*$("#statistics4-4").text());0===s?e.setText(""):e.setText(s+"<span>+</span>")}});a.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',a.text.style.fontSize="48px",a.animate($("#procent-4").text(),{duration:1500})}if($("#perstatistics1").length){var t=new ProgressBar.Circle(perstatistics1,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=(e.value()*$("#perstatistics1-1").text()).toFixed(1);0===s?e.setText(""):e.setText(s)}});t.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',t.text.style.fontSize="48px",t.animate($("#perprocent-1").text(),{duration:1500})}if($("#perstatistics2").length){var t=new ProgressBar.Circle(perstatistics2,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=(e.value()*$("#perstatistics2-2").text()).toFixed(1);0===s?e.setText(""):e.setText(s)}});t.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',t.text.style.fontSize="48px",t.animate($("#perprocent-2").text(),{duration:1500})}if($("#perstatistics3").length){var t=new ProgressBar.Circle(perstatistics3,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var s=(e.value()*$("#perstatistics3-3").text()).toFixed(1);0===s?e.setText(""):e.setText(s)}});t.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',t.text.style.fontSize="48px",t.animate($("#perprocent-3").text(),{duration:1500})}$(".select").on("click",function(t){if($(this).hasClass("active")){var e=t.target,s=$(this).find(".select-text"),a=$(this).find(".select-value");"LI"==e.tagName?($(s).text($(e).text()),$(a).val($(e).text())):"A"==e.tagName&&($(s).html($(e).html()),$(a).val($(e).text())),$(this).removeClass("active")}else $(".select").removeClass("active"),$(this).addClass("active")}),$(document).on("click",function(t){var e=$(".select");e.is(t.target)||0!==e.has(t.target).length||$(".select").removeClass("active")}),$(".menu-arrow").on("click",function(t){$(".personalArea").toggleClass("personalArea-active")}),$(".range-slider").on("init reInit",function(t,e){var s=e.slideCount;$(this).parents(".range-slider__wrap").find(".range").attr("max",s)}),$(".range-slider").on("afterChange",function(t,e,s){$(this).parents(".range-slider__wrap").find(".range").val(s+1)}),$(".range").on("input change",function(){$(this).parents(".range-slider__wrap").find(".range-slider").slick("slickGoTo",this.value-1)}),0==!$(".datepicker").length&&$(".datepicker").datepicker(),$(window).resize(function(){0==!$(".datepicker").length&&$(".datepicker").datepicker("hide")}),$(".methods-drop li a").on("click",function(t){t.preventDefault(),$(".methods-drop li a").removeClass("active"),$(".methods-tab").removeClass("active");var e=$(t.target).attr("href");$(e).addClass("active"),$(this).addClass("active"),$(this).parents(".methods-col__menu").find(".methods-last").text($(this).text())}),$(".methods-col__menu").on("click",function(t){$(this).toggleClass("active")});var i=$(".modal");$(".button-modal").on("click",function(t){t.preventDefault(),$(".header").removeClass("header-active");var e=$(this).attr("href");$(i).addClass("open"),$(".modal-overlay").addClass("open-overlay"),$(".modal").addClass(e),$(".modal").find(".modal-tab").removeClass("active"),$(".modal").find("#"+e).addClass("active")}),$(".modal-close, .modal-overlay").on("click",function(){$(i).removeClass("open"),$(".modal-overlay").removeClass("open-overlay")}),$(".scrollbar-outer").scrollbar()});