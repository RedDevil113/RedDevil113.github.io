...
$(document).ready(function(){AOS.init(),$(".instructor-slider,.testimonials-slider").slick({infinite:!0,arrows:!1,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:500,centerMode:!0,variableWidth:!0,responsive:[{breakpoint:768,settings:{centerMode:!1}}]}),$(".header-menu, .main-info").on("click","a",function(t){t.preventDefault();var e=$(this).attr("href"),a=$(e).offset().top;$("html, body").animate({scrollTop:a},900),$(".header").removeClass("header-active")}),$(".header-bar").on("click",function(){$(".header").toggleClass("header-active"),$(t).removeClass("open"),$(".modal-overlay").removeClass("open-overlay")}),$(".drop-text").on("click",function(t){t.preventDefault(),$(this).parents(".drop").toggleClass("active"),$(window).width()<=960&&$(this).next().slideToggle()}),$(document).on("click",function(t){var e=$(".header");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".header").removeClass("header-active")}),$(document).on("click",function(t){var e=$(".drop");e.is(t.target)||0!==e.has(t.target).length||$(".form-btn").is(t.target)||$(".drop").removeClass("active")}),$(".instructor-overlay").on("click",function(){var t=$(this).parents(".instructor-video");url=$(t).find(".instructor-url").text(),$(this).addClass("active"),$(t).find("iframe").attr("src",url)}),$(".tab-list li a").on("click",function(t){t.preventDefault(),$(".tab-list li a").removeClass("active"),$(".tab").removeClass("tab-active");var e=$(t.target).attr("href");$(e).addClass("tab-active"),$(this).addClass("active")}),$(".accordeon .accordeon-block").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-active")?$(".accordeon").removeClass("accordeon-active"):($(".accordeon").removeClass("accordeon-active"),$(this).parents(".accordeon").addClass("accordeon-active")),$(this).parents().find(".accordeon-block").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()});var t=$(".modal");if($(".button-modal").on("click",function(e){e.preventDefault(),$(".header").removeClass("header-active");var a=$(this).attr("href");$(t).addClass("open"),$(".modal-overlay").addClass("open-overlay"),$(".modal").addClass(a),$(".modal").find(".modal-tab").removeClass("active"),$(".modal").find("#"+a).addClass("active")}),$(".modal-close, .modal-overlay").on("click",function(){$(t).removeClass("open"),$(".modal-overlay").removeClass("open-overlay")}),$(".input-textarea textarea").keyup(function(){var t=$(this).val().length;$(this).attr("maxlength","1000").parents(".input-textarea").find(".input-textarea__info b").text(1e3-t)}),$("#statistics1").length){var e=new ProgressBar.Circle(statistics1,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics1-1").text());0===a?e.setText(""):e.setText(a)}});e.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',e.text.style.fontSize="48px",e.animate($("#procent-1").text(),{duration:1500})}if($("#statistics2").length){var a=new ProgressBar.Circle(statistics2,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics2-2").text());0===a?e.setText(""):e.setText(a+"<span>+</span>")}});a.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',a.text.style.fontSize="48px",a.animate($("#procent-2").text(),{duration:1500})}if($("#statistics3").length){var o=new ProgressBar.Circle(statistics3,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics3-3").text());0===a?e.setText(""):e.setText(a+"<span>+</span>")}});o.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',o.text.style.fontSize="48px",o.animate($("#procent-3").text(),{duration:1500})}if($("#statistics4").length){var s=new ProgressBar.Circle(statistics4,{color:"#FFB42D",strokeWidth:5,trailWidth:5,easing:"easeInOut",duration:1400,text:{autoStyleContainer:!1},from:{color:"#FFB42D",width:5},to:{color:"#FFB42D",width:5},step:function(t,e){e.path.setAttribute("stroke",t.color),e.path.setAttribute("stroke-width",t.width);var a=Math.round(e.value()*$("#statistics4-4").text());0===a?e.setText(""):e.setText(a+"<span>+</span>")}});s.text.style.fontFamily='"Montserrat", Helvetica, sans-serif',s.text.style.fontSize="48px",s.animate($("#procent-4").text(),{duration:1500})}});