...
$(document).ready(function(){$(".about-certificates__slider").slick({infinite:!0,arrows:!0,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,variableWidth:!0,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(".article-center__slider").slick({infinite:!0,arrows:!0,dots:!1,fade:!0,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(".range-brands__slider").slick({infinite:!0,arrows:!0,dots:!0,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:3,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(".main-partners__slider").slick({infinite:!0,arrows:!0,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,variableWidth:!0,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(".header-catalog").on("click",function(){$(this).toggleClass("header-catalog__active"),$(".catalog-sidebar").toggleClass("catalog-sidebar__open")}),$(".header-basket").on("click",function(){$(this).toggleClass("header-basket__active"),$(".basket").toggleClass("basket-open")}),$(".header-menu").on("click",function(){$(this).toggleClass("header-menu__active"),$(".main-menu").toggleClass("main-menu__open")}),$(".header-phone").on("click",function(){$(this).toggleClass("header-phone__active"),$(".phone-drop").toggleClass("phone-drop__open")}),$(".drop-info__head").on("click",function(){$(this).toggleClass("drop-info__head-open").next().slideToggle()}),$(".catalog-filter__title").on("click",function(){$(this).parents(".catalog-filter__col").toggleClass("catalog-filter__col-open")}),$(".catalog-header__filter,.catalog-filter__header p").on("click",function(){$(".catalog-filter").toggleClass("catalog-filter__open")}),$(".decorated-btn").on("click",function(){$(this).parents(".decorated").toggleClass("decorated-active")}),$(".orders-col__info").on("click",function(){$(this).toggleClass("orders-col__info-open").next().slideToggle()}),$(".orders-block__drop p").on("click",function(){$(this).parents(".orders-block__drop").toggleClass("orders-block__drop-open")}),$(".orders-data__main").on("click",function(){$(this).parents(".orders-block").toggleClass("orders-block__open")}),$(".card-tabs__info-title").on("click",function(){$(this).toggleClass("card-tabs__info-title__open").next().slideToggle()}),$(".tab-link").on("click",function(e){e.preventDefault(),$(".tab-link").parents(".tabs-block").removeClass("tabs-active"),$(this).parents(".tabs-block").addClass("tabs-active"),$(".tab-block").removeClass("tab-active");var o=$(e.target).attr("href");$(o).addClass("tab-active")}),$(".main-slide").mouseover(function(){$(this).hasClass("main-slide__active")||($(".main-slide").removeClass("main-slide__active"),$(this).addClass("main-slide__active"))}).mouseout(function(){$(".main-slide").removeClass("main-slide__active"),$(".main-slide-1").addClass("main-slide__active")}),0!=$("#slider-range__1").length&&($("#slider-range__1").slider({range:!0,min:0,max:1e5,values:[800,63e3],slide:function(e,o){$("#search-price__1").text(o.values[0]+" ₽"),$("#search-price__2").text(o.values[1]+" ₽")}}),$("#search-price__1").text($("#slider-range__1").slider("values",0)+" ₽"),$("#search-price__2").text($("#slider-range__1").slider("values",1)+" ₽")),$(".accordeon .accordeon-info").hide().prev().click(function(){$(this).parents(".accordeon").hasClass("accordeon-open")?$(".accordeon").removeClass("accordeon-open"):($(".accordeon").removeClass("accordeon-open"),$(this).parents(".accordeon").addClass("accordeon-open")),$(this).parents().find(".accordeon .accordeon-info").not(this).slideUp().prev(),$(this).next().not(":visible").slideDown().prev().parents()}),console.log($(".article-center").innerWidth()),$(".article-center__position-side").css("right",($(".article-center").innerWidth()-$(".wrapper").width())/2+"px"),$(window).resize(function(){$(".article-center__position-side").css("right",($(".article-center").innerWidth()-$(".wrapper").width())/2+"px")}),$(".m-phone").mask("+7(999) 999-99-99")});