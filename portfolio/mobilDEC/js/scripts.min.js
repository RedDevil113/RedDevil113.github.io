...
var rellax=new Rellax(".rellax"),video={init:function(){video.play()},play:function(){jQuery("body").on("click","#play-video-btn",function(e){video.setSrc(this)})},setSrc:function(e){if(e){var t=jQuery(e).data("id"),a="//www.youtube.com/embed/"+t+"?enablejsapi=1&version=3&showinfo=0&playerapiid=ytplayer&autoplay=1";jQuery("img#embed-video-preview").hide(),jQuery("#play-video-btn").hide(),jQuery("iframe#embed-video-frame").attr("src",a).fadeIn()}}};$(document).ready(function(){var e=($(".header"),$(".header nav ul li,.main-descr,.issues-text p"));$(e).on("click","a",function(e){e.preventDefault();var t=$(this).attr("href"),a=$(t).offset().top;$("html, body").animate({scrollTop:a},1200)}),$(".scroll-down").on("click",function(){var e=$(this).attr("data-scroll"),t=$(e).offset().top;$("html, body").animate({scrollTop:t},300)}),$(".team-slider").slick({centerMode:!0,infinite:!0,variableWidth:!0,arrows:!1,dots:!1,slidesToShow:5,slidesToScroll:1,autoplay:!0,autoplaySpeed:2e3,speed:500,responsive:[{breakpoint:1124,settings:{slidesToShow:3}},{breakpoint:800,settings:{slidesToShow:3}}]}),$(".header-lang__select").on("click",function(){$(this).toggleClass("header-lang__select-active"),$(".header-lang ul").slideToggle(200)}),$(".about-top__info-mark").on("click",function(){$(".about-top__info-mark").removeClass("about-top__info-mark__open"),$(this).toggleClass("about-top__info-mark__open")}),$(".about-tabs__menu li").on("click",function(){$(".about-bottom__tab").removeClass("about-bottom__tab-active"),$(".about-tabs__menu li").removeClass("tabs-menu__active"),$(this).addClass("tabs-menu__active");var e=$(this).attr("data-tab");$("#"+e).addClass("about-bottom__tab-active")}),video.init(),$(".issues-accordeon div p").hide().prev().click(function(){$(this).parents(".issues-accordeon div").hasClass("accordeon-active")?$(".issues-accordeon div").removeClass("accordeon-active"):($(".issues-accordeon div").removeClass("accordeon-active"),$(this).parents(".issues-accordeon div").addClass("accordeon-active")),$(this).parents().find(".issues-accordeon div p").not(this).slideUp(200).prev(),$(this).next().not(":visible").slideDown(200).prev().parents()}),$(".issues-accordeon div.accordeon-active p").show(),$("#range").attr("step","50000"),$("#range").on("input",function(){var e=+$("#range").val(),t=$("#year-1 b,#col-year-1 b"),a=$("#year-2 b,#col-year-2 b"),o=$("#year-3 b,#col-year-3 b"),s=$("#year-4 b,#col-year-4 b"),i=$("#year-5 b,#col-year-5 b"),r=$("#calculator-profit b");e>=1e6?($("#range").attr("step","200000"),console.log("dfsa"),105e4!=e&&125e4!=e&&145e4!=e&&165e4!=e&&185e4!=e&&205e4!=e&&225e4!=e&&245e4!=e&&265e4!=e&&285e4!=e&&305e4!=e&&325e4!=e&&345e4!=e&&365e4!=e&&385e4!=e&&405e4!=e&&425e4!=e&&445e4!=e&&465e4!=e&&485e4!=e&&505e4!=e||(e-=5e4)):$("#range").attr("step","50000"),$(".calculator-rate__title span").text(e),t.text(e+e/100*20),a.text(e+e/100*25),o.text(e+e/100*30),s.text(e+e/100*35),i.text(e+e/100*40),r.text(e/100*160),$("#table-col__1").css("height",($("#year-1 b").text()-e)/2e4+"%"),$("#table-col__2").css("height",($("#year-2 b").text()-e)/2e4+"%"),$("#table-col__3").css("height",($("#year-3 b").text()-e)/2e4+"%"),$("#table-col__4").css("height",($("#year-4 b").text()-e)/2e4+"%"),$("#table-col__5").css("height",($("#year-5 b").text()-e)/2e4+"%"),console.log($("#year-1 b").text()),console.log($("#range").attr("step"))})});