...
$(document).ready(function(){$("form.callback").submit(function(){var a=$(this);return $.ajax({type:"POST",url:"mail.php",data:a.serialize()}).done(function(){$(".modal").removeClass("open"),$(".modal-overlay").removeClass("open-overlay"),a.trigger("reset"),setTimeout(function(){$(".modal").find(".success").removeClass("form-active").fadeOut(),a.trigger("reset")},3e3)}),!1}),$(window).width()>768&&(!function(a){a.fn.animated=function(e){a(this).each(function(){var t=a(this);t.css("opacity","0").addClass("animated").waypoint(function(a){"down"===a&&t.addClass(e).css("opacity","1")},{offset:"90%"})})}}(jQuery),$("section").animated("fadeIn","fadeOutDown")),$(".header-menu, .main-info").on("click","a",function(a){a.preventDefault();var e=$(this).attr("href"),t=$(e).offset().top;$("html, body").animate({scrollTop:t},900),$(window).width()<="860"&&($(".menu-bar").toggleClass("menu-bar__open"),$(".header-menu").slideToggle(200))}),$(".catalog-tab__list li a").on("click",function(a){a.preventDefault(),$(this).parents(".catalog-card").find(".catalog-tab__list li a").removeClass("active"),$(this).parents(".catalog-card").find(".catalog-tab").removeClass("catalog-tab__active");var e=$(a.target).attr("href");$(e).addClass("catalog-tab__active"),$(this).addClass("active")}),$(".examples-tab__list li a").on("click",function(a){a.preventDefault(),$(".examples-tab__list li a").removeClass("active"),$(".examples-tab").removeClass("examples-tab__active");var e=$(a.target).attr("href");$(e).addClass("examples-tab__active"),$(this).addClass("active")}),$(".reviews-slider").slick({infinite:!0,arrows:!0,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(".menu-bar").on("click",function(){$(this).toggleClass("menu-bar__open"),$(".header-menu").slideToggle(200)});var a=$(".modal");$(".modal-overlay");$(".button-modal").on("click",function(a){a.preventDefault();var e=$(this).attr("href");$(e).addClass("open"),$(".modal-overlay").addClass("open-overlay");var t=$(this).parents(".hidden-input").find(".hidden-input__value").text();$("#info-form").val(t)}),$(".cancel, .modal-overlay").on("click",function(){$(a).removeClass("open"),$(".modal-overlay").removeClass("open-overlay")})});