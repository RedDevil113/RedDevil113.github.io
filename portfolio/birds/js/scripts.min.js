...
$(document).ready(function(){$(window).width()>768&&(!function(e){e.fn.animated=function(t){e(this).each(function(){var a=e(this);a.css("opacity","0").addClass("animated").waypoint(function(e){"down"===e&&a.addClass(t).css("opacity","1")},{offset:"90%"})})}}(jQuery),$("section").animated("fadeIn","fadeOutDown")),$(".catalog-tab__list li a").on("click",function(e){e.preventDefault(),$(this).parents(".catalog-card").find(".catalog-tab__list li a").removeClass("active"),$(this).parents(".catalog-card").find(".catalog-tab").removeClass("catalog-tab__active");var t=$(e.target).attr("href");$(t).addClass("catalog-tab__active"),$(this).addClass("active")}),$(".examples-tab__list li a").on("click",function(e){e.preventDefault(),$(".examples-tab__list li a").removeClass("active"),$(".examples-tab").removeClass("examples-tab__active");var t=$(e.target).attr("href");$(t).addClass("examples-tab__active"),$(this).addClass("active")}),$(".reviews-slider").slick({infinite:!0,arrows:!0,dots:!1,nextArrow:'<button class="slick-arrow slick-next"></button>',prevArrow:'<button class="slick-arrow slick-prev"></button>',slidesToShow:1,slidesToScroll:1,autoplay:!0,autoplaySpeed:1e4,speed:1e3}),$(".eTimer").eTimer({etType:1,etDate:"07.10.2017.0.0",etTitleText:"",etTitleSize:10,etShowSign:1,etSep:":",etFontFamily:"Open Sans Bold",etTextColor:"#a3a3a3",etPaddingTB:9,etPaddingLR:20,etBackground:"transparent",etBorderSize:0,etBorderRadius:5,etBorderColor:"white",etShadow:" 0px 0px 0px 0px #333333",etLastUnit:4,etNumberFontFamily:"OpenSansBold",etNumberSize:24,etNumberColor:"#826ac5",etNumberPaddingTB:1,etNumberPaddingLR:5,etNumberBackground:"#f8f6fc",etNumberBorderSize:0,etNumberBorderRadius:4,etNumberBorderColor:"white",etNumberShadow:" 0px 0px 0px 0px rgba(0, 0, 0, 0)"}),$(".menu-bar").on("click",function(){$(this).toggleClass("menu-bar__open"),$(".header-menu").slideToggle(200)})});